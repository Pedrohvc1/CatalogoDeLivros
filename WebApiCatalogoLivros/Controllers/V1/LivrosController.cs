...
using WebApiCatalogoLivros.Services;
using WebApiCatalogoLivros.ViewModel;

namespace WebApiCatalogoLivros.Controllers.V1
{
    ...
    public class LivrosController : ControllerBase
    {
        ...
        /// <param name="quantidade">Indica a quantidade de regístros por página. Mínimo 1 e máximo 50</param>
        /// <response code="200">Retorna a lista de livros</response>
        /// <response code="204">Caso não haja livros</response>
        [HttpGet]
        public async Task<ActionResult<IEnumerable<LivroViewModel>>> Obter([FromQuery, Range(1, int.MaxValue)] int pagina = 1,
        ...
        public async Task<ActionResult<LivroViewModel>> InserirLivro([FromBody] LivroInputModel livroInputModel)
        {
            ...
            {
                return UnprocessableEntity("Já existe um livro com este nome para esta produtora");
            }
        }
