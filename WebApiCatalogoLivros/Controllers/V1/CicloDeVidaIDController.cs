...
namespace WebApiCatalogoLivros.Controllers.V1
{
    ...
    public class CicloDeVidaIDController : ControllerBase
    {
        ...
        public readonly IExemploScoped _exemploScoped1; // scoped - uma instancia que perdura durante toda requisicao 
                                       ...
                                       IExemploTransient exemploTransient2)
        {
            ...
            _exemploTransient1 = exemploTransient1; // Transient - toda vez que voce usa ele ele te da uma instancia nova
